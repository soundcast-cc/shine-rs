...
- [帧数限制功能](docs/FRAME_LIMIT_FEATURE.md)
- [帧数限制快速参考](docs/FRAME_LIMIT_QUICK_REFERENCE.md)
- [高级 API 使用指南](docs/HIGH_LEVEL_API.md)
- [日志系统使用指南](docs/LOGGING_SYSTEM.md)
- [音频文件标准化](docs/AUDIO_FILES_STANDARDIZATION.md)
- [验证记录](docs/VERIFICATION_RECORD.md)
- [性能基准测试](tests/encoder_benchmark.rs)
